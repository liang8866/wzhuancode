...
cc.Class({
    ...
    onPostGetLog()
    {
        ...
        HttpHelper.httpPost(cc.UrlTable.url_person_news,psdata,onPostCallBack,this);
    ...
    onShowLogLayout(list)
    {
        ...
        for (const key in list) {
            if (list.hasOwnProperty(key)) {
                ...
                var script = item.getComponent('tonggaoitem');
        ...
        if ( this.contentNode.height < (1180 +cc.iphone_off_Y *4)) {
            this.contentNode.height = 1180 +cc.iphone_off_Y *4;
        }
    },
    ...
    onClickExit()
    {
        ...
        cc.onDestoryView(cc.PanelID.PERSON_TONGGAO); 
    }
